...
| POST   | `/activities/{activity_name}/signup?email=student@mergington.edu` | Register a student; team activities also require `team_name` (teacher login required) |
...
| POST   | `/activities/{activity_name}/teams/{team_name}/members` | Add a member to an existing team (teacher login required) |
